...
## Update July 21-7-2020
-Textual Visual semantic Dataset (400K) for COCO-caption is added `Textual_visual_inforamtion_COCO_caption`

-Train file updated with more data (100K) `train_v3.csv` 
## Motivation
