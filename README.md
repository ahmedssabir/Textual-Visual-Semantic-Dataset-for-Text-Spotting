...
- The conditional probability of  object/text happen togaher in COCO-text  <img src="![formula] (P(w\vert c)\;=\;\frac{freq(w,c)}{freq(c)}]("> `object-text-co-occurrence-(P(w|c)` 
